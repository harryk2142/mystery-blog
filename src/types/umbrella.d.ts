declare module "umbrellajs" {
	export interface Umbrella {
		new (parameter: this | string | Element | ArrayLike<Element | null> | null): this;
		new (selector: string, context?: Element | Document | null): this;
		new (): this;

		(parameter: this | string | Element | ArrayLike<Element | null> | null): this;
		...
		is(callback: (this: this, node: Element, index: number) => boolean): boolean;
		...
		wrap(parameter: this | string | Element | ArrayLike<Element | null> | null): this;
	}
